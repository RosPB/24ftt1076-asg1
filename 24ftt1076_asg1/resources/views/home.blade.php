...
<main class="flex flex-col items-center justify-center flex-1 px-6 py-12">
    <div class="bg-white rounded-xl shadow-lg p-10 w-full max-w-xl">
        ...
        <img url="https://i.pinimg.com/736x/53/c8/09/53c8091689f3cf997ed3bddf23f547aa.jpg.jpg".jpg" alt="blue emoji mewing" class="mx-auto mb-8 w-1/2 rounded-lg shadow-md">
